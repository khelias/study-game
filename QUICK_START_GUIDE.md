...
{ variant: 'default' } // bg-slate-50 border-slate-300 text-slate-700

// Success - green (goal achieved)
{ variant: 'success' } // bg-green-50 border-green-400 text-green-700

// Warning - orange (caution needed)
{ variant: 'warning' } // bg-orange-50 border-orange-400 text-orange-700

// Danger - red (critical state)
{ variant: 'danger' } // bg-red-50 border-red-400 text-red-700
...
const stats: GameStat[] = [
  { id: 'counter', value: debouncedValue }
];
```
