...
export const GAME_CONFIG: Record<string, GameConfig> = {
  ...
  pattern:         { id: 'pattern', title: 'PATTERN TRAIN', theme: THEME.teal!, icon: 'TrainFront', desc: 'Continue the pattern', allowedProfiles: ['starter'], difficulty: 'easy', category: 'logic', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.pattern.hintEliminateCost' }] },
  ...
  battlelearn:     { id: 'battlelearn', title: 'BATTLELEARN', theme: THEME.blue!, icon: 'Anchor', desc: 'Answer and sink ships', allowedProfiles: ['starter'], difficulty: 'medium', category: 'math', levelUpStrategy: 'onGameWin', paidHints: [{ id: 'reveal_empty', icon: '💧', cost: 1, labelKey: 'games.battlelearn.hintRevealEmptyCost' }, { id: 'reveal', icon: '🎯', cost: 10, labelKey: 'games.battlelearn.hintRevealCost' }] },
  ...
  pattern_adv:      { id: 'pattern', title: 'PATTERN TRAIN', theme: THEME.teal!, icon: 'TrainFront', desc: 'Continue the pattern', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'logic', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.pattern.hintEliminateCost' }] },
  ...
  battlelearn_adv: { id: 'battlelearn_adv', title: 'BATTLELEARN', theme: THEME.blue!, icon: 'Anchor', desc: 'Master coordinates and arithmetic', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'math', levelUpStrategy: 'onGameWin', paidHints: [{ id: 'reveal_empty', icon: '💧', cost: 1, labelKey: 'games.battlelearn.hintRevealEmptyCost' }, { id: 'reveal', icon: '🎯', cost: 10, labelKey: 'games.battlelearn.hintRevealCost' }] },
};
