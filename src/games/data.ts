...
export const GAME_CONFIG: Record<string, GameConfig> = {
  ...
  word_builder:    { id: 'word_builder', title: 'WORD MASTER', theme: THEME.orange!, icon: 'FileText', emoji: '📝', desc: 'Build a word from letters', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'language', paidHints: [{ id: 'reveal_next', icon: '🔤', cost: 1, labelKey: 'games.word_builder.hintRevealNextCost' }, { id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.word_builder.hintEliminateCost' }] },
  word_cascade:    { id: 'word_cascade', title: 'WORD CASCADE', theme: THEME.pink!, icon: 'Layers', emoji: '🌊', desc: 'Catch letters and build words fast', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'language', paidHints: [{ id: 'reveal_next', icon: '🔤', cost: 1, labelKey: 'games.word_cascade.hintRevealNextCost' }] },
  syllable_builder:{ id: 'syllable_builder', title: 'SYLLABLE MASTER', theme: THEME.orange!, icon: 'Layers', emoji: '📖', desc: 'Put syllables together into a word', allowedProfiles: ['starter'], difficulty: 'easy', category: 'language' },
  pattern:         { id: 'pattern', title: 'PATTERN TRAIN', theme: THEME.teal!, icon: 'TrainFront', emoji: '🚂', desc: 'Continue the pattern', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'logic', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.pattern.hintEliminateCost' }] },
  sentence_logic:  { id: 'sentence_logic', title: 'SENTENCE DETECTIVE', theme: THEME.green!, icon: 'BookOpen', emoji: '🔍', desc: 'Where is the object?', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'language' },
  memory_math:     { id: 'memory_math', title: 'MATH MEMORY', theme: THEME.green!, icon: 'Brain', emoji: '🧠', desc: 'Find the equation and answer', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'memory', paidHints: [{ id: 'reveal_pair', icon: '👁️', cost: 1, labelKey: 'games.memory_math.hintRevealPairCost' }] },
  picture_pairs:   { id: 'picture_pairs', title: 'PICTURE PAIRS', theme: THEME.pink!, icon: 'Layers', emoji: '🖼️', desc: 'Match pictures and words', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'memory', paidHints: [{ id: 'reveal_pair', icon: '👁️', cost: 1, labelKey: 'games.picture_pairs.hintRevealPairCost' }] },
  robo_path:       { id: 'robo_path', title: 'ROBO PATH', theme: THEME.indigo!, icon: 'Bot', emoji: '🤖', desc: 'Program the robot', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'logic' },
  math_snake:      { id: 'math_snake', title: 'NUMBER SNAKE', theme: THEME.purple!, icon: 'Gamepad2', emoji: '🐍', desc: 'Move and collect apples', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.math_snake.hintEliminateCost' }] },
  letter_match:    { id: 'letter_match', title: 'LETTER DETECTIVE', theme: THEME.pink!, icon: 'Search', emoji: '🔤', desc: 'Find the correct letter', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'language' },
  unit_conversion: { id: 'unit_conversion', title: 'UNITS', theme: THEME.blue!, icon: 'Ruler', emoji: '📐', desc: 'Convert units', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.unit_conversion.hintEliminateCost' }] },
  compare_sizes:   { id: 'compare_sizes', title: 'NUMBER COMPARE', theme: THEME.indigo!, icon: 'Hash', emoji: '⚖️', desc: 'Compare numbers', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.compare_sizes.hintEliminateCost' }] },
  star_mapper:     { id: 'star_mapper', title: 'STAR MAPPER', theme: THEME.indigo!, icon: 'Star', emoji: '⭐', desc: 'Learn the constellations', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'logic', paidHints: [{ id: 'guide', icon: '💡', cost: 1, labelKey: 'games.star_mapper.hintGuideCost' }, { id: 'connect', icon: '✨', cost: 2, labelKey: 'games.star_mapper.hintConnectCost' }] },
  shape_shift:     { id: 'shape_shift', title: 'SHAPE SHIFT', theme: THEME.teal!, icon: 'Shapes', emoji: '🧩', desc: 'Build shapes from pieces', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'logic', paidHints: [{ id: 'outline', icon: '👁️', cost: 1, labelKey: 'games.shape_shift.hintOutlineCost' }, { id: 'place', icon: '🧩', cost: 2, labelKey: 'games.shape_shift.hintPlacePieceCost' }] },
  battlelearn:     { id: 'battlelearn', title: 'BATTLELEARN', theme: THEME.blue!, icon: 'Anchor', emoji: '⚓', desc: 'Answer and sink ships', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', levelUpStrategy: 'onGameWin', paidHints: [{ id: 'reveal_empty', icon: '💧', cost: 1, labelKey: 'games.battlelearn.hintRevealEmptyCost' }, { id: 'reveal', icon: '🎯', cost: 10, labelKey: 'games.battlelearn.hintRevealCost' }, { id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.battlelearn.hintEliminateCost' }] },
  shape_dash:      { id: 'shape_dash', title: 'SHAPE DASH', theme: THEME.teal!, icon: 'Gamepad2', emoji: '🏃', desc: 'Jump, dodge, and answer geometry', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'logic', paidHints: [{ id: 'reveal_gate', icon: '🎯', cost: 2, labelKey: 'games.shape_dash.hintRevealGateCost' }, { id: 'slow_time', icon: '⏱️', cost: 3, labelKey: 'games.shape_dash.hintSlowTimeCost' }] },
  // Advanced-only games (7+)
  balance_scale:   { id: 'balance_scale', title: 'SCALES', theme: THEME.blue!, icon: 'Scale', emoji: '⚖️', desc: 'Balance the scales', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.balance_scale.hintEliminateCost' }] },
  time_match:      { id: 'time_match', title: 'CLOCK GAME', theme: THEME.blue!, icon: 'Clock3', emoji: '🕐', desc: 'Set the time', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.time_match.hintEliminateCost' }] },
};
