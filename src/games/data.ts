...
export const GAME_CONFIG: Record<string, GameConfig> = {
  ...
  shape_dash:      { id: 'shape_dash', title: 'SHAPE DASH', theme: THEME.teal!, icon: 'Gamepad2', emoji: '🏃', desc: 'Jump, dodge, and answer geometry', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'logic' },
