...
export const GAME_CONFIG: Record<string, GameConfig> = {
  ...
  word_builder:    { id: 'word_builder', title: 'WORD MASTER', theme: THEME.orange!, icon: 'FileText', desc: 'Build a word from letters', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'language', paidHints: [{ id: 'reveal_next', icon: '🔤', cost: 1, labelKey: 'games.word_builder.hintRevealNextCost' }, { id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.word_builder.hintEliminateCost' }] },
  ...
  memory_math:     { id: 'memory_math', title: 'MATH MEMORY', theme: THEME.green!, icon: 'Brain', desc: 'Find the equation and answer', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', paidHints: [{ id: 'reveal_pair', icon: '👁️', cost: 1, labelKey: 'games.memory_math.hintRevealPairCost' }] },
  ...
  unit_conversion: { id: 'unit_conversion', title: 'UNITS', theme: THEME.blue!, icon: 'Ruler', desc: 'Convert units', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.unit_conversion.hintEliminateCost' }] },
  compare_sizes:   { id: 'compare_sizes', title: 'NUMBER COMPARE', theme: THEME.indigo!, icon: 'Hash', desc: 'Compare numbers', allowedProfiles: ['starter', 'advanced'], difficulty: 'easy', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.compare_sizes.hintEliminateCost' }] },
  ...
  battlelearn:     { id: 'battlelearn', title: 'BATTLELEARN', theme: THEME.blue!, icon: 'Anchor', desc: 'Answer and sink ships', allowedProfiles: ['starter', 'advanced'], difficulty: 'medium', category: 'math', levelUpStrategy: 'onGameWin', paidHints: [{ id: 'reveal_empty', icon: '💧', cost: 1, labelKey: 'games.battlelearn.hintRevealEmptyCost' }, { id: 'reveal', icon: '🎯', cost: 10, labelKey: 'games.battlelearn.hintRevealCost' }] },
  // Advanced-only games (7+)
  balance_scale:   { id: 'balance_scale', title: 'SCALES', theme: THEME.blue!, icon: 'Scale', desc: 'Balance the scales', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.balance_scale.hintEliminateCost' }] },
  time_match:      { id: 'time_match', title: 'CLOCK GAME', theme: THEME.blue!, icon: 'Clock3', desc: 'Set the time', allowedProfiles: ['advanced'], difficulty: 'hard', category: 'math', paidHints: [{ id: 'eliminate', icon: '❌', cost: 1, labelKey: 'games.time_match.hintEliminateCost' }] },
};
