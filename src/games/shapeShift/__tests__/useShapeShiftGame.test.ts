...
describe('useShapeShiftGame', () => {
    const mockProblem: ShapeShiftProblem = {
        ...
        puzzle: {
            ...
            gridSize: 10,
            pieces: [
                { id: 'p1', type: 'square', color: 'red', correctPosition: { x: 0, y: 0 }, correctRotation: 0, size: 2 }
            ]
        },
        pieces: [
            { id: 'p1', type: 'square', color: 'red', correctPosition: { x: 0, y: 0 }, correctRotation: 0, isDecoy: false, currentPosition: null, currentRotation: 0, size: 2 }
        ],
        showHints: true
    };
